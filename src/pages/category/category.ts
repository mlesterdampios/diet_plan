        ...
        if(userLoginInfo != null){
         ...
         if(this.user.bmi_mode==3){
            for(var i=0; i < this.categorys.length; i++){
               this.categorys[i].profile_img = "assets/images/obese"+(i+1)+".png";
            }
         }
         if(this.user.bmi_mode==2){
            for(var i=0; i < this.categorys.length; i++){
               this.categorys[i].profile_img = "assets/images/well-fitted"+(i+1)+".png";
            }
         }
         if(this.user.bmi_mode==1){
            for(var i=0; i < this.categorys.length; i++){
               this.categorys[i].profile_img = "assets/images/malnourished"+(i+1)+".png";
            }
         }
        }else{
